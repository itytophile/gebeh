...
impl MmuCpuExt for State {
    fn read(&self, index: u16, _: u64, cpu: &Cpu, peripherals: PeripheralsRef) -> u8 {
        match index {
            ...
            CH3_PERIOD_LOW => 0xff,
            0xff1f => 0xff,
            CH4_LENGTH_TIMER => 0xff,
            CH4_VOLUME_AND_ENVELOPE => self.ch4_volume_and_envelope,
            CH4_FREQUENCY_AND_RANDOMNESS => self.ch4_frequency_and_randomness,
            CH4_CONTROL => self.ch4_control | 0b10111111,
    ...
    fn write(&mut self, index: u16, value: u8, _: u64, cpu: &mut Cpu, peripherals: Peripherals) {
        ...
        match index {
            ...
            0xff1f => {}
            CH4_LENGTH_TIMER => self.ch4_length_timer = value,
            CH4_VOLUME_AND_ENVELOPE => self.ch4_volume_and_envelope = value,
            CH4_FREQUENCY_AND_RANDOMNESS => self.ch4_frequency_and_randomness = value,
